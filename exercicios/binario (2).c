...

{
    ...
    for(e_nro>1; cont=0;){
        ...
        for (tmp=cont-1; tmp>=0; tmp--){
            switch(tmp){
            case 0: printf("%i",e_s0);break;
            case 1: printf("%i",e_s1);break;
            case 2: printf("%i",e_s2);break;
            case 3: printf("%i",e_s3);break;
            case 4: printf("%i",e_s4);break;
            case 5: printf("%i",e_s5);break;
            case 6: printf("%i",e_s6);break;
            case 7: printf("%i",e_s7);break;
            case 8: printf("%i",e_s8);break;
            case 9: printf("%i",e_s9);break;
